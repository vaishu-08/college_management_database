...
[Click here to get full code](https://github.com/vaishu-08/college_management_database/blob/main/college_database_code.sql)
...
<img src="image/7.png" alt="que_7" width = "200"/> &nbsp; 
 ...
 Q  9 . "the first book issued by each student?"
  ...
  Q  10 .  "the most popular book per branch?"
   ...
   Q  11   "the last 3 books issued by each student?"
   
  <img src="image/11.png" alt="que_11" width = "200"/> &nbsp;

   Q  12 .  "students who have issued books?"

   <img src="image/12.png" alt="que_12" width = "200"/> &nbsp;

   Q  13 . "books that have never been issued but are expensive?"

   <img src="image/13.png" alt="que_13" width = "200"/> &nbsp;

   Q 14 . "the least expensive book?"
